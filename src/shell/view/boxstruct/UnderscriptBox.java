...
import shell.control.boxhandler.UnderscriptBoxHandler;
import shell.model.document.Attribute;

public class UnderscriptBox extends ComponentBox {

	protected ComponentBox base;

	protected ComponentBox script;

	public UnderscriptBox(int orderNo) {
		super(orderNo);
	}

	public UnderscriptBox(GeneralBox underscriptBox) {
		super(underscriptBox.getDocument(), underscriptBox.parent,
				underscriptBox.orderNo, underscriptBox.arguments,
				underscriptBox.attributes);
	}
	...
	public void calculateArguments(int width) {
		...
		script.arguments.posY = base.arguments.height + base.arguments.depth;
	}
	...
	public GeneralBox generateCopy() {
		UnderscriptBox newUnderscriptBox = new UnderscriptBox(this);
		return newUnderscriptBox;
	}

	@Override
	public void generateHandler() {
		handler = new UnderscriptBoxHandler(this);
	}
